...
<div class="page-hero">
    <div class="container">
        <div style="font-size:3rem; margin-bottom:16px; opacity:0.9;"><i class="fas fa-download"></i></div>
        <h1>Downloads</h1>
    </div>
</div>
...
<div class="breadcrumb-bar">
    <div class="container">
        ...
        <a href="#">Home</a>
        <span>&rsaquo;</span>
        <span style="color: var(--text-dark); font-weight:600;">Downloads</span>
    </div>
</div>
...
<head>
    ...
    <title>Downloads | GCEE</title>
    <meta name="description" content="Downloads - Government College of Engineering, Erode (GCEE)">
...
<form action="MQApplication.php" method="post">
